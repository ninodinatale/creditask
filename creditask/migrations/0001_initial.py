# Generated by Django 3.0.4 on 2020-11-10 12:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed_property', models.CharField(choices=[('NAME', 'Name'), ('NEEDED_TIME_SECONDS', 'Neededtimeseconds'), ('STATE', 'State'), ('CREDITS_CALC', 'Creditscalc'), ('FIXED_CREDITS', 'Fixedcredits'), ('FACTOR', 'Factor'), ('USER_ID', 'Userid'), ('PERIOD_START', 'Periodstart'), ('PERIOD_END', 'Periodend'), ('APPROVAL', 'Approval')], max_length=30, null=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
