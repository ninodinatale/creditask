...
# from creditask.models import User, Task, BaseModel
#
#
...
#             self.assertEqual(1, mock_fn.call_count)
#
#             first_call_args: Task = mock_fn.call_args[0][0]
#
#             expected_call_args = dict(
#                 id=str(create_input.get('factor')),
#                 name=create_input.get('name')
#             )
#             self.assertEqual(first_call_args.id, expected_call_args.get('factor'))
#             self.assertEqual(first_call_args.name, expected_call_args.get('name'))
#
...
#                 factor=update_input.get('factor')
#             )
#             self.assertEqual(first_call_args.id, expected_call_args.get('id'))
#             self.assertEqual(first_call_args.name, expected_call_args.get('name'))
#             self.assertEqual(first_call_args.factor, expected_call_args.get('factor'))
